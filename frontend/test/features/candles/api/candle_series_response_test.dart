...
void main() {
  test('CandleSeriesResponse_handlesEmptyList', () {
    final json = {'symbol': 'BTCUSDT', 'timeframe': '1m', 'candles': <dynamic>[]};
    ...
    expect(() => resp.candles.add(CandleDto(timestamp: DateTime.utc(2024, 1, 1), open: 1, high: 1, low: 1, close: 1, volume: 1)), throwsUnsupportedError);
  });
}
